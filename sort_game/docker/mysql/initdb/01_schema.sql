...
CREATE TABLE IF NOT EXISTS battles (
  ...
  CONSTRAINT fk_battles_user FOREIGN KEY (user_id) REFERENCES users(id),
  CONSTRAINT chk_array_size CHECK (array_size BETWEEN 5 AND 100),
  CONSTRAINT chk_benchmark_size CHECK (benchmark_size BETWEEN 100 AND 10000)
) ENGINE=InnoDB
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS battle_results (
  ...
  CONSTRAINT fk_algorithm FOREIGN KEY (algorithm_id) REFERENCES algorithms(id) ON DELETE RESTRICT ON UPDATE CASCADE,
